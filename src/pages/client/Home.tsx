        ...
        <>
            <section className="content w-screen">
                ...
                <nav className="content1 w-screen mx-auto mt-[200px] mb-[200px] flex ">
                    {/* <!-- card --> */}
                    <div className="font-sans  w-full flex flex-row justify-center items-center hover:scale-110 transition ">
                            ...
                            {isLoading ? (
                                ...
                                <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 ">
                                    {dataSource?.map((item: any) => (
                                        <li key={item.key} className="bg-white rounded-lg border shadow-md overflow-hidden hover:shadow-lg hover:shadow-blue-300 hover:scale-105 transition ease-out duration-500">
