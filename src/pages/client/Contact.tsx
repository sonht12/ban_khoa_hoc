    ...
    <>
      <section className="content pt-[89px] bg-[#D2E6E4]">
            ...
            <section className="text-gray-600  relative ">
                ...
                <div className="container px-3 py-24 mx-auto  mb-4">
                    <div   className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full  md:mt-0 relative  shadow-md">
                      
                        <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Nhận xét</h2>
                        <p className="leading-relaxed mb-3 text-gray-600">Phản hồi về trải nghiệm của bạn cho chúng tôi!.
                        </p>
                        ...
                        <div className="relative mb-2 ">
                            ...
                            <textarea id="message" name="message"
                                className="w-full h-10 bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200  text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                        </div>
                        <button type="submit"
